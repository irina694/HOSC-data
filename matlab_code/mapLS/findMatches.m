function matches=findMatches(cells, Gvars)
                    ...
                    for i=1:nn
                        ...
                        if (ParentDir == symbolDir)                        
                            ...
                            if(~isempty(candidates))                             
                                match=testCandidates(edges,ed1Index,markers(i),candidates,areas(Nc),coords(cellvert,:), Gvars);                    
                                if(~isempty(match))
...
function match=testCandidates(edges,originEd,originMk,candidates,area0,coords, Gvars)  
