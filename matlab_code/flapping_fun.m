...
if connectivity.error == 0
    ...
    coeff_zpp = -kin.omega*kin.omega*N_vector.*N_vector.*a;
    kin.zpp = real(expMatrix*coeff_zpp');
    ...
    % calculate the coefficients for the flapping motion
    f_motion = expMatrix*b';
    ...
    % calculate the coefficients for the second derivative
    coeff_fpp = -kin.omega*kin.omega*N_vector.*N_vector.*b;
    kin.fpp = real(expMatrix*coeff_fpp');
    
    % the pitching motion
    c_0 = A(1,4*N+5);
    c = A(1, 4*N+6:6*N+6);
        
    % calculate the coefficients for the pitching motion
    th = expMatrix*c';
    kin.th = real(c_0 + th);
    ...
    % calculate the coefficients for the second derivative
    coeff_thpp = -kin.omega*kin.omega*N_vector.*N_vector.*c;
    kin.thpp = real(expMatrix*coeff_thpp');
