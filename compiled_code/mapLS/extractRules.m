function [rules,direct,thick,elast,press]=extractRules(x, Gvars)
    ...
    for i=1:Nrules
        ...
        for j=j0:j1
            ...
            jj1 = j*Gvars.Ncodes;
            [letter,dir,thck,elst,prss]=getletter(abs(x(jj0:jj1)),mod(j,2), Gvars);
            if(letter~=' ')            
...
function [y,d,t,e,p]=getletter(x,f, Gvars)
