function cells=createNewCells(cells,matches,Prules, Gvars)
    ...
    cells = updateEdProperties(cells,Prules,matches, Gvars);
end

        

function cells = updateEdProperties(cells,Prules,matches, Gvars)
