...
function[g] = flapping_fun_topo(x, plot_decide, time_skip)
...
[connectivity,connectivity.error] = create_cell(x, Gvars, input); 
...
%                 figure(2)
%                 trisurf(FEA.trielements,FEA.x,FEA.y,FEA.z,'facecolor','none','edgecolor','k')
%                 hold on
...
%                             %subplot(4,3,2),
%                             plot([connectivity.vertices.coords(connectivity.edges.vertices(j,1),1),connectivity.vertices.coords(connectivity.edges.vertices(j,2),1)],[connectivity.vertices.coords(connectivity.edges.vertices(j,1),2),connectivity.vertices.coords(connectivity.edges.vertices(j,2),2)],'r-','MarkerEdgeColor','k','LineWidth',.5); hold on;
%                         else
%                             %subplot(4,3,2),
%                             plot([connectivity.vertices.coords(connectivity.edges.vertices(j,1),1),connectivity.vertices.coords(connectivity.edges.vertices(j,2),1)],[connectivity.vertices.coords(connectivity.edges.vertices(j,1),2),connectivity.vertices.coords(connectivity.edges.vertices(j,2),2)],'k-','MarkerEdgeColor','k','LineWidth',2); hold on;
%                         end
%                     end
                   % axis equal; axis([-1.01 1.01 -1.01 1.01]); 
                  % axis off
...
%                     filename = [fdirout, '/', fbaseout, int2str(i), '.ppm'];
